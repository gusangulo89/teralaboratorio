                                ...
                                <div class="card">
                                        ...
                                        <div class="collapse" id="collapseExample">
                                          <div class="card card-body">
                                            <form action="tareas_add.php" method="POST">
                                                <div class="row">
                                                <div class="col-1">
                                                    <label for="usr">Usuario</label>
                                                    <select class="form-control form-control-sm" name="usr" autofocus>
                                                    <?php 
                                                ...
                                                <div class="col-5">
                                                    ...
                                                    <input type="text" name="tarea" class="form-control form-control-sm" id="tarea" placeholder="Escribe aqui la tarea">
                                                </div>
                                                <div class="col-2">
                                                ...
                                                <div class="col-5">
                                                    ...
                                                    <input type="text" name="observaciones" class="form-control form-control-sm" placeholder="Escribe tus observaciones">
                                                </div>

                                                </div>
                                                <div class="row">
                                                    <div class="col ms-auto p-2">
                                                     <input type="submit" class="btn btn-secondary btn-sm" name="guardar_tarea" value="Guardar">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-body">
                                            <table id="datatablesSimple" class="table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    $query="SELECT tareas.id, usuarios.iniciales, tareas.tarea, tareas.creado_el, estatus.nombre_estatus, tareas.observaciones FROM `tareas` LEFT JOIN usuarios ON tareas.usr=usuarios.idlogin LEFT JOIN estatus ON tareas.estatus_tarea=estatus.id ORDER BY estatus.id ASC";
                                                    $resultado = mysqli_query($conn, $query);
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="badge <?php
                                                         ...
                                                         "><?php  echo $row['nombre_estatus']; ?></span>
                                                        </td>
                                                        <td><?php echo $row['observaciones'] ?></td>
                                                        <td><a href="tareas_edit.php?id=<?php echo$row['id'] ?>"><i class="far fa-edit"></i></a></td>
                                                    </tr>
                                                <?php } ?>
                                                </tbody>
                                            </table>
