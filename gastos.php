 ...
 <div id="layoutSidenav_content">
                <main>
                    <div class="container px-4">
                        <h1 class="mt-4"><i class="fas fa-money-bill-alt"></i> Control de Gastos</h1> 
                              ...
                              <div class="container-fluid">
                                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                  <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                      <a class="nav-link" aria-current="page" href="#"> <i class="fas fa-folder-open"></i> Por Proyecto</a>
                                    </li>
                                  </ul>
                                </div>
                              </div>
...
<!-- AQUI COMIENZA EL FOOTER-->
        ...
        <script src="addons/bootstrap/js/bootstrap.min.js" crossorigin="anonymous"></script>
