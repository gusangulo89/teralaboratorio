                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="#!">
                             ...
                             <a class="nav-link active" href="lecciones.php">
 ...
 <div id="layoutSidenav_content">
                <main>
                    <div class="container px-4">
                        <h1 class="mt-4"><i class="fas fa-chalkboard-teacher"></i> Lecciones aprendidas <span class="badge bg-secondary">2</span></h1> 
